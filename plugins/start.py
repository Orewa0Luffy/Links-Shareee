...
async def start_command(client: Bot, message: Message):
    ...
    if len(text) > 7:
        ...
        START_CAPTION = (
            "<b><i><blockquote><b>ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ᴀᴅᴠᴀɴᴄᴇᴅ ʟɪɴᴋs sʜᴀʀɪɴɢ ʙoᴛ.</i></b>\n\n"
            "ᴜsᴇ ᴛʜɪs ʙᴏᴛ ᴛᴏ sᴀғᴇʟʏ sʜᴀʀᴇ ᴄᴏɴᴛᴇɴᴛ ᴡɪᴛʜᴏᴜᴛ ʀɪsᴋɪɴɢ ᴄᴏᴘʏʀɪɢʜᴛ ᴛᴀᴋᴇᴅᴏᴡɴs.\n"
            "ᴇxᴘʟᴏʀᴇ ᴛʜᴇ ᴏᴘᴛɪᴏɴs ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ sᴛᴀʀᴛᴇᴅ!</blockquote>"
        )

        inline_buttons = InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("ᴀɴɪᴍᴇ ᴄʜᴀɴɴᴇʟ", url="https://t.me/Animes_Union")],
                [InlineKeyboardButton("sᴇʀɪᴇs ᴄʜᴀɴɴᴇʟ", url="https://t.me/Series_Union")],
                [InlineKeyboardButton("ᴄᴏɴᴛᴀᴄᴛ ᴀᴅᴍɪɴ", url="https://t.me/Union_Owner")],
...
async def help_callback(client: Bot, callback_query):
    ...
    await callback_query.message.edit_text(
        "<b><i>About Us..\n\n‣ Made for : @Union_Association\n‣ Owned by : @Union_Owner\n‣ Developer : @Union_Owner\n\nAdios !!</i></b>",
        reply_markup=inline_buttons
    )
